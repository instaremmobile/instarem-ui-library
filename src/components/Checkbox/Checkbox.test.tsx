...
describe('Checkbox Component', () => {
  ...
  describe('User Interactions', () => {
    ...
    it('calls onChange with false when unchecking', async () => {
      ...
      render(<Checkbox {...defaultProps} checked={true} onChange={mockOnChange} />);
    ...
    it('does not call onChange when disabled', async () => {
      ...
      render(<Checkbox {...defaultProps} disabled={true} onChange={mockOnChange} />);
  ...
  describe('Indeterminate State', () => {
    ...
    it('updates indeterminate property when prop changes', () => {
      const { rerender } = render(<Checkbox {...defaultProps} indeterminate={false} />);
